...
| EAS Update | live, branch `production`, runtimeVersion policy `appVersion`; last group `4dd4a029-6db4-4950-bae5-26e06928e2a3` (2026-09-12, runtime `1.0.4`, `gitCommitHash dfef89a46` on branch `ota/work-rows-1.0.4`) — see the publish log below. `main` targets 1.0.5, so 1.0.4 phones are served from that branch until build 45 ships |
