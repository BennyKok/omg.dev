...
| EAS Update | live, branch `production`, runtimeVersion policy `appVersion`. Two runtimes are in the field: `1.0.5` last group `73c5214e-65fb-4d2b-8727-bf25b6a9c8a3` (2026-09-12, `2d346fff4`, main); `1.0.4` last group `6d7bffd9-2328-47bf-aefc-f71d9024446e` (2026-09-12, `3d2125807`, main with only app version held at 1.0.4). Both include inline queue confirmation, immediate queue placement, and combined work-row fixes. Publish BOTH for every phone-visible change until 1.0.4 is retired; check the installed version before attributing a missing change. |
