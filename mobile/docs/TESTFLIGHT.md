...
| EAS Update | live, branch `production`, runtimeVersion policy `appVersion`. Two runtimes are in the field: `1.0.5` (build 45) last group `37876cb1-cc0f-490b-80a3-c92d1fecf8f4` (2026-09-12, `gitCommitHash 370bfb29b`, from `main`); `1.0.4` (build 44 and earlier) last group `bb49b0fc-68ac-4690-a91c-92b7a6f991eb` (2026-09-12, `gitCommitHash 8a5273be2`, `main` with `app.json` held at 1.0.4). Publish BOTH for every phone-visible change until 1.0.4 is retired; check the phone's installed version before attributing a missing change |
