...
| Latest TestFlight build | `1.0.4 (42)` — built and submitted 2026-09-11 through `mobile-release.yml` run 34578077935 from `ed3352fb8` (EAS build `8d179277-063d-4b5d-9cd5-afcc48c91d79`), carrying every change from this session in the binary. **Submitted for App Store review** the same day with `mobile/scripts/asc-submit-review.py`: version `1.0.4` (`029f7ceb-ea5e-4aa9-ab71-ae86338d41a3`), release type `AFTER_APPROVAL` (goes live on approval, no press), review submission `1ad4c7b4-7daf-4e68-beef-bbaa1a40c85c`. Build 41 (run 34571573067) was uploaded earlier the same day and superseded. The App Store serves `1.0.3 (39)` until approval. |
| EAS Update | live, branch `production`, runtimeVersion policy `appVersion`; last group `5b043665-7aa3-4210-8586-4255e84323b9` (2026-09-11, runtime `1.0.4`, `gitCommitHash 5e4648546`) — see the publish log below |
